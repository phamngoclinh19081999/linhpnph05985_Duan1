...
public class FragmentMaindishes extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        layoutHome = inflater.inflate(R.layout.fragment_maindishes,container,false);
        mData = FirebaseDatabase.getInstance().getReference();
        recyclerM();
        return layoutHome;
    }

    public void recyclerM(){
        recyclerviewBook = layoutHome.findViewById(R.id.recycleOrderM);
        linearLayoutManager = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);

        bookArrayList = new ArrayList<>();
        mData.child("Food").child("Maindishes").addChildEventListener(new ChildEventListener() {
            @Override

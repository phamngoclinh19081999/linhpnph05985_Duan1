...
public class FragmentSup extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        layoutHome = inflater.inflate(R.layout.fragment_sup,container,false);
    ...
    public void recycler(){
        recyclerviewBook = layoutHome.findViewById(R.id.recycleOrderV);
        linearLayoutManager = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);

        bookArrayList = new ArrayList<>();
        mData.child("Food").child("Vegetables").addChildEventListener(new ChildEventListener() {
            @Override
